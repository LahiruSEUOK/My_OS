; Aurora Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE AURORAOS_VER '1.0.0'	 ;OS version number
	%DEFINE AURORAOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as AURORAOS and its programs
...
option_screen:
	...
	os_init_msg		db '  AURORA...', 0
	os_version_msg		db 'Version ', AURORAOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db '  Version ', AURORAOS_VER, 0

	dialog_string_1		db '   AURORA Operating System...   ', 0
	dialog_string_2		db 'Please select SELECT for HardwareInfo or', 0
	dialog_string_3		db 'select QUIT to exit from the OS.', 0
...
os_draw_background1:
	...
	mov cx, 00000111b		; Colour: white text on black
...
os_hardware:
	...
	exitmsg			db	"Press ESC key to quit........"
